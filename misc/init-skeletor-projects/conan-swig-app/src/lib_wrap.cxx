...
#define SWIGTYPE_p_LibSample swig_types[0]
...
#define SWIG_name      "lib"
#define SWIG_init      luaopen_lib
#define SWIG_init_user luaopen_lib_user

#define SWIG_LUACODE   luaopen_lib_luacode
...
static int _wrap_new_LibSample(lua_State* L) {
  {
    int SWIG_arg = 0;
    LibSample *result = 0 ;
    
    SWIG_check_num_args("LibSample::LibSample",0,0)
    result = (LibSample *)new LibSample();
    SWIG_NewPointerObj(L,result,SWIGTYPE_p_LibSample,1); SWIG_arg++; 
    return SWIG_arg;
...
static int _wrap_LibSample_Print(lua_State* L) {
  {
    int SWIG_arg = 0;
    LibSample *arg1 = (LibSample *) 0 ;
    
    SWIG_check_num_args("LibSample::Print",1,1)
    if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("LibSample::Print",1,"LibSample *");
    
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_LibSample,0))){
      SWIG_fail_ptr("LibSample_Print",1,SWIGTYPE_p_LibSample);
    }
...
static void swig_delete_LibSample(void *obj) {
LibSample *arg1 = (LibSample *) obj;
delete arg1;
}
static int _proxy__wrap_new_LibSample(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_LibSample);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_LibSample_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_LibSample_methods[]= {
    { "Print", _wrap_LibSample_Print},
    {0,0}
};
static swig_lua_method swig_LibSample_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_LibSample_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_LibSample_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_LibSample_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_LibSample_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_LibSample_Sf_SwigStatic = {
    "LibSample",
    swig_LibSample_Sf_SwigStatic_methods,
    swig_LibSample_Sf_SwigStatic_attributes,
    swig_LibSample_Sf_SwigStatic_constants,
    swig_LibSample_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_LibSample_bases[] = {0};
static const char *swig_LibSample_base_names[] = {0};
static swig_lua_class _wrap_class_LibSample = { "LibSample", "LibSample", &SWIGTYPE_p_LibSample,_proxy__wrap_new_LibSample, swig_delete_LibSample, swig_LibSample_methods, swig_LibSample_attributes, &swig_LibSample_Sf_SwigStatic, swig_LibSample_meta, swig_LibSample_bases, swig_LibSample_base_names };
...
static swig_type_info _swigt__p_LibSample = {"_p_LibSample", "LibSample *", 0, 0, (void*)&_wrap_class_LibSample, 0};
...
static swig_cast_info _swigc__p_LibSample[] = {  {&_swigt__p_LibSample, 0, 0, 0},{0, 0, 0, 0}};
